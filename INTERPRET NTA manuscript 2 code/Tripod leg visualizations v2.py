...
df1 = pd.read_csv('WW2DW Data Analysis file 4 (Structure level only, all results) v5 (formatted).csv')


df_substance = pd.read_csv('WW2DW Data Analysis file 3 (Substance and structure level, all results) v5.csv')
